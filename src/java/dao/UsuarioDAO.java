...
public class UsuarioDAO implements DAO<Usuario> {
    ...
    private static final String QUERY_BUSCAR = "SELECT idUsuario, nomeUsuario, cpf, email, telefone, senha, e.rua, r.numero, r.complemento, r.bairro, r.cep,   FROM tb_usuario WHERE id_usuario = ?";
